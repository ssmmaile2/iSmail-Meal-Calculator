        ...
        <>
          ...
          >
            <h2 style={{ fontSize: 20, marginBottom: 12 }}>
              العناصر/المجموعات التي لا يجتمع معها
            </h2>
            ...
            {logs.length === 0 ? (
              ...
              <div style={{ display: "grid", gap: 10 }}>
                {logs.map((log) => (
                  ...
                  >
                    <div>
                      <strong>التاريخ:</strong> {new Date(log.consumed_at).toLocaleString()}
                    </div>
                    <div>
                      <strong>الكمية:</strong> {log.qty_g}غ
                    </div>
                    {log.notes ? (
                      <div>
                        <strong>ملاحظة:</strong> {log.notes}
                      </div>
                    ) : null}
                  </div>
                ))}
